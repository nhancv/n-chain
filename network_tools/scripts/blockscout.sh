...
sudo -u $EC2_USER ENV=$ENV BLOCKSCOUT_RPC=$BLOCKSCOUT_RPC BLOCKSCOUT_CHAINID=$BLOCKSCOUT_CHAINID BLOCKSCOUT_URL=$BLOCKSCOUT_URL BLOCKSCOUT_PROTOCOL=$BLOCKSCOUT_PROTOCOL /tmp/app.sh
