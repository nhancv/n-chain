...
export BLOCKSCOUT_PROTOCOL="$BLOCKSCOUT_PROTOCOL"
export BLOCKSCOUT_PROTOCOL_WS="$BLOCKSCOUT_PROTOCOL_WS"
...
sudo -u $EC2_USER ENV=$ENV BLOCKSCOUT_RPC=$BLOCKSCOUT_RPC BLOCKSCOUT_CHAINID=$BLOCKSCOUT_CHAINID BLOCKSCOUT_URL=$BLOCKSCOUT_URL BLOCKSCOUT_PROTOCOL=$BLOCKSCOUT_PROTOCOL BLOCKSCOUT_PROTOCOL_WS=$BLOCKSCOUT_PROTOCOL_WS /tmp/app.sh
